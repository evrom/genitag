...
from libraries.config.profile.forms import ContactMe as Form
from libraries.forms import Blank as BlankForm
from libraries.config.profile.insert import contactme as description_insert
from libraries.config.profile.select import contactme as description_select
from libraries.config.profile.delete import contactme as description_delete
from libraries.session import open_session
app = Bottle()


@app.route('/config/profile/contactme', method=['POST', 'GET'])
