...
from libraries.config.profile.forms import Name as Form
from libraries.forms import Blank as BlankForm
from libraries.config.profile.insert import name as name_insert
from libraries.config.profile.select import name as name_select
from libraries.config.profile.delete import name as name_delete
