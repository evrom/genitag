from wtforms import StringField, validators,\
    TextAreaField, PasswordField, RadioField,\
...
class EventFlags(Form):
    location = BooleanField('Flag location as changed?')
    datetime = BooleanField('Flag date/time as changed?')
    canceled = BooleanField('Flag this event as Canceled?')
